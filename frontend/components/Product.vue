            ...
            <div class="pt-6">
                <div class="mb-4 flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center justify-end gap-1">
                        ...
                        <div id="tooltip-quick-look-2" role="tooltip"
                            class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-gray-800 opacity-0 shadow-sm transition-opacity duration-300"
                ...
                <ul class="mt-2 flex items-center gap-4">
                    <li class="flex items-center gap-2">
                        ...
                        <p class="text-sm font-medium text-gray-500">Best Seller
                        </p>
                    </li>
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <p class="text-sm font-medium text-gray-500">Best Price
                        </p>
                    </li>
                </ul>
