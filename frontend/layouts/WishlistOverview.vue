<template>
    <div class="space-y-3">
        <div class="bg-white rounded-lg border px-6 pt-5 pb-2 shadow-sm">
            ...
            <div
                ...
                <img
                    class="max-w-sm w-full h-auto my-10"
            ...
            <template v-else>
                ...
                <div class="flex justify-end">
                    <ConfirmationModal
                        ...
                        <span
                            class="flex my-4 px-3 py-2 text-gray-800 bg-gray-100 hover:bg-gray-200 border border-gray-200 font-medium text-sm rounded-md">
