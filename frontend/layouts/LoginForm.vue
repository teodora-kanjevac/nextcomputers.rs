<template>
    <div class="sm:min-h-screen flex flex-col justify-center items-center">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="w-full md:px-8 md:py-7 p-5 space-y-4">
                        ...
                        <form @submit.prevent="submitForm">
                            ...
                            <div
                                v-if="loginError"
                                class="p-3 mb-4 text-xs font-medium text-red-800 rounded-md bg-red-100 flex items-center">
...
const submitForm = () => {
    ...
    const isCredentialsValid = form.value.email === 'test' && form.value.password === 'test'
    loginError.value = !isCredentialsValid
