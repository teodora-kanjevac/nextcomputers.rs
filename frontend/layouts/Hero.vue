<template>
    <div>
        <section class="bg-white pt-5 md:xl:pt-10">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1 class="max-w-2xl mb-6 text-3xl font-bold leading-none md:text-4xl xl:text-5xl text-gray-800">
                    ...
                    <a href="#"
                        class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-light active:bg-primary">
                        Get started
