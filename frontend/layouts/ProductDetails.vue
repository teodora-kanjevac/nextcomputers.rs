<template>
    <div>
        <div class="md:grid md:grid-cols-2 md:gap-8 xl:gap-16">
            <div class="gap-4">
                <img :src="featuredImage" class="h-auto max-w-full mx-auto rounded-lg mb-3 sm:mb-5"
                    alt="Featured Image">
                ...
                <div class="grid grid-cols-5 gap-2 sm:gap-3">
                    <div v-for="(image, index) in galleryImages" :key="index">
                        ...
                        }" class="h-full max-w-full mx-auto rounded-lg cursor-pointer" @click="updateFeatured(image)"
                            alt="Gallery Image">
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 md:mt-0">
                <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">Na
                    stanju</span>
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="flex-col">
                        <div class="">
                            ...
                            <p class="text-xl line-through font-bold leading-tight text-gray-500 mt-3 mb-1 ms-0.5">
                                1,249.99 RSD
                            </p>
                        </div>
                        <p class="text-3xl sm:text-4xl font-extrabold leading-tight text-gray-900">
                            1,249.99 <span class="text-xl sm:text-2xl">RSD</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-6 flex flex-col gap-6 sm:flex-row items-start justify-around text-sm">
                    <div class="grid grid-cols-2 gap-x-6 gap-y-2">
                        ...
                        <span class="font-semibold">Dijagonala ekrana:</span>
                        <span>10,9"</span>

                        <span class="font-semibold">Rezolucija:</span>
                        <span>2360 x 1640</span>

                        <span class="font-semibold">Procesor:</span>
                        <span>Hexa Core</span>

                        <span class="font-semibold">SIM kartica:</span>
                        <span>da</span>

                        <span class="font-semibold">RAM memorija:</span>
                        <span>4 GB</span>

                        <span class="font-semibold">Interna memorija:</span>
                        <span>64 GB</span>
                    </div>

                    <div class="grid grid-cols-2 gap-x-6 sm:gap-x-0 gap-y-2">
                        <span class="font-semibold">Šifra artikla:</span>
                        <span>32145676</span>

                        <span class="font-semibold">EAN:</span>
                        <span>8806084194343</span>

                        <span class="font-semibold">Model:</span>
                        <span>F4WR913P3WA</span>
                    </div>
                </div>
            </div>
        </div>
