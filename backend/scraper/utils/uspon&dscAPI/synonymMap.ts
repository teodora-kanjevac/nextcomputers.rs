export const synonymMap: Record<string, string[]> = {
    'aparati za tretiranje vazduha': ['ventilatori / osveživači / ovlaživači', 'aparati za tretiranje vazduha'],
    hlađenje: ['hladnjaci', 'case cooler', 'cpu cooler', 'ventilator', 'pasta'],
    kosilice: ['kosačice'],
    'tastature i miševi': ['podloga', 'podloge', 'miševi', 'tastature', 'kombo setovi'],
    ...
    'pametni satovi i fitnes narukvice': ['smartwatch', 'pametni satovi'],
    ...
    'tableti i oprema': ['tablet računari', 'oprema za tablete', 'grafičke table', 'tableti'],
    ...
    'kablovi i adapteri': ['zaštitni kablovi', 'adapter', 'kabl'],
    'mašine za pranje sudova': ['mašine za pranje sudova', 'mašine za sudove'],
}
