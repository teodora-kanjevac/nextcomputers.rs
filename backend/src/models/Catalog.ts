...
export class Catalog {
    ...
    constructor(catalog: any) {
        ...
        this.product_mpn = catalog.mpn
        this.product_name = catalog.name
        this.product_url = "https://nextcomputers.rs/proizvod/" + catalog.product_id
        this.product_price = catalog.sale_price
        this.product_price_discount = (catalog.sale_price) * 0.99
        this.product_description = catalog.description
